...
public:
    ...
    enum WindowTypes {kWindowRect, kWindowTriangle, kWindowHann, kWindowHamming, kWindowCosine, kWindowBlackman, kWindowBlackman62, kWindowBlackman70, kWindowBlackman74, kWindowBlackman92, kWindowBlackmanHarris, kWindowFlatTop, kWindowKaiser, kWindowTukey };
    ...
    IndexedWindowFunctions()
    {
        ...
        WindowFunctions<T, uint32_t>::add(kWindowBlackman, window_blackman);
        WindowFunctions<T, uint32_t>::add(kWindowBlackman62, window_blackman_62);
        WindowFunctions<T, uint32_t>::add(kWindowBlackman70, window_blackman_70);
