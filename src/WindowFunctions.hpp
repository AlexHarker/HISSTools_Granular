...
public:
    ...
    IndexedWindowFunctions()
    {
        ...
        WindowFunctions<T, uint>::add(kWindowFlatTop, window_flat_top);
        
        WindowFunctions<T, uint>::add(kWindowKaiser, window_kaiser);

        WindowFunctions<T, uint>::add(kWindowTukey, window_tukey);
}
};
